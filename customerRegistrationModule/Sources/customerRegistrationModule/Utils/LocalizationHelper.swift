...
public extension Notification.Name {
    static let CustomerRegistrationLocalizationDidChange = Notification.Name("CustomerRegistrationModule.LocalizationDidChange")
}

public final class CustomerRegistrationLocalizationHelper: @unchecked Sendable {
    public static let shared = CustomerRegistrationLocalizationHelper()
    ...
    @objc private func systemPreferencesChanged() {
        if currentLanguage == nil {
            updateFromSystemPreferences()
            NotificationCenter.default.post(name: .CustomerRegistrationLocalizationDidChange, object: currentLanguage)
        }
    }
...
public extension String {
    static func customerRegistrationLocalized(_ key: String, arguments: CVarArg...) -> String {
        return CustomerRegistrationLocalizationHelper.shared.localizedString(for: key, arguments: arguments)
    }
}
