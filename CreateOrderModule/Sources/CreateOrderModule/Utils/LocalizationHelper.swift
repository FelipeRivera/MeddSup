...
public extension Notification.Name {
    static let CreateOrderLocalizationDidChange = Notification.Name("CreateOrderModule.LocalizationDidChange")
}

public final class CreateOrderLocalizationHelper: @unchecked Sendable {
    public static let shared = CreateOrderLocalizationHelper()
    ...
    @objc private func systemPreferencesChanged() {
        if currentLanguage == nil {
            updateFromSystemPreferences()
            NotificationCenter.default.post(name: .CreateOrderLocalizationDidChange, object: currentLanguage)
        }
    }
...
public extension String {
    static func createOrderLocalized(_ key: String, arguments: CVarArg...) -> String {
        return CreateOrderLocalizationHelper.shared.localizedString(for: key, arguments: arguments)
    }
}
